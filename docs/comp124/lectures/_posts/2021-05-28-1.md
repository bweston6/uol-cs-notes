...
Start at 2 and then count forward 4, which gives you 5 elements: $b, a,a, c, a$. As sets don't have repeating elements this gives the set of: $\\{a, b, c\\}$. For another example see [this example]({{site.baseurl}}/comp124/lectures/2021/05/06/2.html#example).
