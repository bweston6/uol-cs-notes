...
For more information see [Operating Systems Overview]({% post_url 2021-03-06-1 %}).
...
See [Swapping]({{site_baseurl}}/comp124/lectures/2021/05/04/2.html#swapping) from Memory Fragmentation.
...
* [FCFS and Shortest Job First]({% post_url 2021-03-10-1 %})
* [Shortest Remaining Time and Priority Scheduling]({% post_url 2021-03-11-1 %})
* [Round Robin]({% post_url 2021-03-12-1 %})
...
[This table]({{site_baseurl}}/comp124/lectures/2021/05/12/1.html#extended-backus-naur-form) explains the EBNF notation. 
...
See [Addresssing Modes]({{site_baseurl}}/comp124/lectures/2021/02/16/1.html#addressing-modes). This refers to the forms that operands can take.
...
The EFLAGS register is used when comparing two values, see [Comparing Values]({{site_baseurl}}/comp124/lectures/2021/02/17/1.html#comparing-values). This triggers the `jg` instruction if the first operand is greater.
...
See [Yielding]({{site_baseurl}}/comp124/lectures/2021/04/22/1.html#yielding). Any thread is able to yield.
...
Remember to count the letter that the working set starts on. For the method see [this example]({{site_baseurl}}/comp124/lectures/2021/05/06/2.html#example).
