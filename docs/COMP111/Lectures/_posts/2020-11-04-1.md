...
\begin{cases}
	...
	\max&#95;&#123;n\in\text{Succ}(s)}\text{MMV}(n) & \max\text{moves in}\ s&#92;&#92;
	\min&#95;&#123;n\in\text{Succ}(s)}\text{MMV}(n) & \min\text{moves in}\ s
\end{cases}
&#92;]

This this definition &#92;(\text{MinimaxV}&#92;) has been shortened to &#92;(\text{MMV}&#92;).
{:.info}.
