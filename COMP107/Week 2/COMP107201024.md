...
* Needs a principle approach as it is often hard for users to articulate their need or their buisness problems. 
* Any system that doesn't meet the users need is neither uerful nor useable.
...
When eliciting form people you should take into account who you want to talk to. There should be adequate stakeholders to get comprehensive coverage. There should be selection based on role, position, decision power, usage, expertise, exposure to problems, interests and influence on uptake.

Interviewing can also be difficult at there may be:
